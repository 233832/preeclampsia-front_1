import { NotificacionClinica } from '../interfaz/configuracion';
...
export const notificacionService = {
    ...
    marcarComoLeida: async (id: number): Promise<NotificacionClinica> => {
        const response = await fetch(`${API_URL}/api/notificaciones/${id}/leida`, {
            method: 'PUT',
        });
